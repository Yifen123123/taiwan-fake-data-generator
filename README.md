...
- 本工具輸出的姓名、出生年月日、地址、手機與身分證字號皆為假資料。
- 台灣身分證字號符合基本格式與檢查碼規則，適合用於測試驗證流程。
- 出生年月日使用台灣民國格式 `YYY年MM月DD日`，例如 `095年03月21日`，年齡範圍控制在 18 到 80 歲。
- 為降低重複率，程式會盡量避免同次產生重複的姓名、出生年月日、信箱、手機與身分證字號。